    ...
    <div ref={signInForm}>
      ...
      <div className="absolute inset-0 flex justify-center items-center min-w-[300px] backdrop-blur-sm">
        ...
        <div className="relative flex flex-col items-center w-[275px] md:w-[325px] gap-2 bg-violet-500/90 rounded-lg p-6">
          ...
          <p className="absolute top-8 float-left w-4/6 min-w-[200px] font-bold text-xl size-1 text-center text-violet-50 mb-14">Sign in to continue</p>
          <button className="w-48 h-16 hover:w-52 p-2 rounded-md mt-14 bg-gradient-to-br from-slate-100 to-slate-100" onClick={() => signIn('google')}>
            ...
            <p className="bg-gradient-to-r from-indigo-500 to-violet-500 text-transparent bg-clip-text subpixel-antialiased font-medium">Sign in with Google</p>
          </button>
          <button className="w-48 h-16 hover:w-52 p-2 rounded-md bg-gradient-to-br from-slate-100 to-slate-100" onClick={() => signIn('github')}>
            ...
            <p className="float-right bg-gradient-to-r  from-indigo-500 to-violet-500 text-transparent bg-clip-text subpixel-antialiased font-medium">Sign in with GitHub</p>
          </button>
        </div>
      </div>
    </div>
